...
# define PLAYER_W "./src/image/back.xpm"
# define PLAYER_A "./src/image/left.xpm"
# define PLAYER_S "./src/image/front.xpm"
# define PLAYER_D "./src/image/right.xpm"
# define BACKGROUND "./src/image/sea.xpm"
# define WALL "./src/image/wall.xpm"
# define EGG "./src/image/egg.xpm"
# define EXIT "./src/image/exit.xpm"
